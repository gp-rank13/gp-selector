...
// List of menu items
const std::vector<std::string> menuNames = { "Show Selector", "Hide Selector", "Toggle Display Numbers", "Toggle Zero-Based Numbers", "Toggle Immediate Switching", "Toggle Large Scroll Area", "Toggle Thick Borders"};
...
const int MIN_BUTTON_HEIGHT = 40;
const int DEFAULT_BUTTON_HEIGHT = 50;
const int MAX_BUTTON_HEIGHT = 100;
const int MIN_WINDOW_WIDTH = 180;
const int LARGE_SCROLL_AREA_WIDTH = 50;
const juce::String DEFAULT_BUTTON_COLOR = "FF3F3F3F";
const juce::String DEFAULT_BUTTON_TEXT_COLOR = "FFC5C5C5";
const juce::String DEFAULT_SUBBUTTON_COLOR = "FF353535";
const juce::String DEFAULT_SUBBUTTON_TEXT_COLOR = "FFE5E5E5";
